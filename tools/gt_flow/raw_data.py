...
class RawData:
    def __init__(self, experiment_name, run_number):
        self.bag_path = downloader.get_data(experiment_name, run_number)[0]

        left_sync_topics = (['/davis/left/image_raw'],[0.05])
    ...
    def play_image(self):
        ...
        fig = plt.figure()
        left_cam = self.left_cam_readers['/davis/left/image_raw']
